...
[`@aws-sdk/client-batch`](https://www.npmjs.com/package/@aws-sdk/client-batch/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-batch@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HALriLNBjPF08Ns5XY0jrbq9ZtfRwGJY0o0fPKMG9Ogk7FI2+dJrtWLZ+p82dBub
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-batch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-batch@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-batch@3.241.0/index.min.mjs": "sha384-HALriLNBjPF08Ns5XY0jrbq9ZtfRwGJY0o0fPKMG9Ogk7FI2+dJrtWLZ+p82dBub"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-batch/blob/refs/tags/3.241.0/LICENSE
```
